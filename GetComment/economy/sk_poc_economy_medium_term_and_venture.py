...
class ECONOY_MEDIUM_TERM_AND_VENTURE(Mother, Url):

    def __init__(self):
        Url.__init__(self)
        Mother.__init__(self)
        self.dirpath = path + "\\medium_term_and_venture"
        self.logpath = path + "\\log\\medium_term_and_venture"
        self.writefilepathComment = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\comment\economy_medium_term_and_venture.json"
        self.writefilepathLike = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\like\economy_medium_term_and_venture.json"
...
if __name__ == "__main__":
    o = ECONOY_MEDIUM_TERM_AND_VENTURE()
    o.listDir()