...
class ECONOY_INDUSTRY_BUSINESS(Mother, Url):

    def __init__(self):
        Url.__init__(self)
        Mother.__init__(self)
        self.dirpath = path + "\\industry_and_business_establishment"
        self.logpath = path + "\\log\\industry_and_business_establishment"
        self.writefilepathComment = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\comment\economy_industry_and_business_establishment.json"
        self.writefilepathLike = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\like\economy_industry_and_business_establishment.json"
