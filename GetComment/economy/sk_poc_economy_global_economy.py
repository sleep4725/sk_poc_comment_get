...
class ECONOY_GLOBAL_ECONOMY(Mother, Url):

    def __init__(self):
        Url.__init__(self)
        Mother.__init__(self)
        self.dirpath = path + "\\global_economy"
        self.logpath = path + "\\log\\global_economy"
        self.writefilepathComment = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\comment\economy_global_economy_comment.json"
        self.writefilepathLike = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\like\economy_global_economy_like.json"
