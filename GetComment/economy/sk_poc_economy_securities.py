...
class ECONOY_SECURITIES(Mother, Url):

    def __init__(self):
        Url.__init__(self)
        Mother.__init__(self)
        self.dirpath = path + "\\securities"
        self.logpath = path + "\\log\\securities"
        self.writefilepathComment = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\comment\economy_securities_comment.json"
        self.writefilepathLike = r"C:\Users\ezfarm\PycharmProjects\sk_poc_comment_get\GetComment\economy\filew\like\economy_securities_like.json"
